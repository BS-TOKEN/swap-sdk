...
import {
  ...
  testBSTC as peripheryTestBSTC,
  BSTC as peripheryBSTC
...
export const FACTORY_ADDRESS: { [chainId: number]: string; } = {
  ...
  [ChainId.TESTBSTC]: testBSTC.factory,
  [ChainId.BSTC]: coreBSTC.factory
};
...
export const ROUTER_ADDRESS: { [chainId in ChainId]?: string } = {
  ...
  [ChainId.TESTBSTC]: peripheryTestBSTC.router,
  [ChainId.BSTC]: peripheryBSTC.router
};
...
export const INIT_CODE_HASH: { [chainId: number]: string; } = {
  ...
  [ChainId.BSTC]: '0x8a9a92045ce74057bcbb6bd831ca6cb0291c41b227fe790d31268fcc6f9159cc' // Honeyswap
};
...
const PERMISSIVE_MULTICALL_ADDRESS: { [chainId: number]: string; } = {
  ...
  [ChainId.BSTC]: '0xB71513791fACA3F124A5f068B7840577678071B1'
};
