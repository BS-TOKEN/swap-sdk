...
import { mainnet, rinkeby, arbitrumTestnetV3, sokol, xdai, matic, testBSTC, BSTC as BSTC$1 } from 'dxswap-core/.contracts.json';
import { rinkeby as rinkeby$1, mainnet as mainnet$1, arbitrumTestnetV3 as arbitrumTestnetV3$1, sokol as sokol$1, xdai as xdai$1, matic as matic$1, testBSTC as testBSTC$1, BSTC as BSTC$2 } from 'dxswap-periphery/.contracts.json';
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = mainnet.factory, _FACTORY_ADDRESS[ChainId.RINKEBY] = rinkeby.factory, _FACTORY_ADDRESS[ChainId.ARBITRUM_TESTNET_V3] = arbitrumTestnetV3.factory, _FACTORY_ADDRESS[ChainId.SOKOL] = sokol.factory, _FACTORY_ADDRESS[ChainId.XDAI] = xdai.factory, _FACTORY_ADDRESS[ChainId.MATIC] = matic.factory, _FACTORY_ADDRESS[ChainId.TESTBSTC] = testBSTC.factory, _FACTORY_ADDRESS[ChainId.BSTC] = BSTC$1.factory, _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.RINKEBY] = rinkeby$1.router, _ROUTER_ADDRESS[ChainId.MAINNET] = mainnet$1.router, _ROUTER_ADDRESS[ChainId.ARBITRUM_TESTNET_V3] = arbitrumTestnetV3$1.router, _ROUTER_ADDRESS[ChainId.SOKOL] = sokol$1.router, _ROUTER_ADDRESS[ChainId.XDAI] = xdai$1.router, _ROUTER_ADDRESS[ChainId.MATIC] = matic$1.router, _ROUTER_ADDRESS[ChainId.TESTBSTC] = testBSTC$1.router, _ROUTER_ADDRESS[ChainId.BSTC] = BSTC$2.router, _ROUTER_ADDRESS);
...
var DXSWAP_TOKEN_LIST_ID = (_DXSWAP_TOKEN_LIST_ID = {}, _DXSWAP_TOKEN_LIST_ID[ChainId.MAINNET] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.RINKEBY] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.ARBITRUM_TESTNET_V3] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.SOKOL] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.XDAI] = 5, _DXSWAP_TOKEN_LIST_ID[ChainId.MATIC] = 137, _DXSWAP_TOKEN_LIST_ID[ChainId.TESTBSTC] = 5005, _DXSWAP_TOKEN_LIST_ID[ChainId.BSTC] = 7007, _DXSWAP_TOKEN_LIST_ID);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MAINNET] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.RINKEBY] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.ARBITRUM_TESTNET_V3] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.SOKOL] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.XDAI] = '0x3f88503e8580ab941773b59034fb4b2a63e86dbc031b3633a925533ad3ed2b93', _INIT_CODE_HASH[ChainId.MATIC] = '0xae81bbc68f315fbbf7617eb881349af83b1e95241f616966e1e0583ecd0793fe', _INIT_CODE_HASH[ChainId.TESTBSTC] = '0x63c52921df830fc505703646b11b5221d795993ba352f631679a51e92087ffcc', _INIT_CODE_HASH[ChainId.BSTC] = '0x8a9a92045ce74057bcbb6bd831ca6cb0291c41b227fe790d31268fcc6f9159cc', _INIT_CODE_HASH);
...
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[ChainId.MAINNET] = Token.WETH[ChainId.MAINNET], _Token$NATIVE_CURRENC[ChainId.RINKEBY] = Token.WETH[ChainId.RINKEBY], _Token$NATIVE_CURRENC[ChainId.ARBITRUM_TESTNET_V3] = Token.WETH[ChainId.ARBITRUM_TESTNET_V3], _Token$NATIVE_CURRENC[ChainId.SOKOL] = Token.WSPOA[ChainId.SOKOL], _Token$NATIVE_CURRENC[ChainId.XDAI] = Token.WXDAI[ChainId.XDAI], _Token$NATIVE_CURRENC[ChainId.MATIC] = Token.WMATIC[ChainId.MATIC], _Token$NATIVE_CURRENC[ChainId.TESTBSTC] = Token.WMATIC[ChainId.TESTBSTC], _Token$NATIVE_CURRENC[ChainId.BSTC] = Token.WETH[ChainId.BSTC], _Token$NATIVE_CURRENC);
/**
...
var TOKEN_LOGO_URI_CACHE = (_TOKEN_LOGO_URI_CACHE = {}, _TOKEN_LOGO_URI_CACHE[ChainId.MAINNET] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.XDAI] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.SOKOL] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.ARBITRUM_TESTNET_V3] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.RINKEBY] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.MATIC] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.TESTBSTC] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.BSTC] = {}, _TOKEN_LOGO_URI_CACHE);
/**
